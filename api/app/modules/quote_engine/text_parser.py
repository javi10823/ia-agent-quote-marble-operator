...
PARSE_SYSTEM = """Sos un parser de medidas para una marmolería.
...
- Mesada: largo × prof (profundidad default cocina: 0.60m si no dice)
- Zócalo: largo × alto (alto default: 0.05m si no dice)
- Alza: largo × alto
...
{
  "pieces": [
    {"description": "Mesada cocina", "largo": 2.0, "prof": 0.60},
