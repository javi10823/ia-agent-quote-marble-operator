                    ...
                    {validation.warnings.map((w, i) => (
                      <div key={i} className="flex items-start gap-2 text-[11px] text-amb/85 py-0.5">
                        <span className="shrink-0 mt-0.5">
                          {w.type === "error" ? (
                            <svg width="10" height="10" viewBox="0 0 24 24" fill="none" stroke="var(--red)" strokeWidth="2"><circle cx="12" cy="12" r="10"/><line x1="15" y1="9" x2="9" y2="15"/><line x1="9" y1="9" x2="15" y2="15"/></svg>
                          ) : (
